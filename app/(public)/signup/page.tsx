...
const signUpInitial = { error: null as string | null, success: false };
...
function SignUpForm() {
  const [state, action] = useFormState(signUpWithPassword, signUpInitial);

  if (state.success) {
    return (
      <div className="flex flex-col items-center gap-3 py-4 text-center">
        <CheckCircle2 className="w-10 h-10 text-primary-600" />
        <p className="text-sm font-medium text-neutral-900">Almost there!</p>
        ...
        <div className="p-6 rounded-xl shadow-card border border-neutral-200 bg-white space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white px-3 text-xs text-neutral-500">or sign up with email</span>
            </div>
          </div>
